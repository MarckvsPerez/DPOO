...
public class BookTest {
    ...
    public void testSetIsbn() {
        ...
        book.setIsbn("1234567%890"); //  Caracters especials
        assertEquals("1234567890", book.getIsbn());

        book.setIsbn("1-2.3,4:5_6asdas7o8p99"); // Lletres i caracters
        assertEquals("1234567899", book.getIsbn());

        book.setIsbn("1-2.3,4:5_6asdas7o8p99"); // Lletres i caracters
        assertEquals("1234567899", book.getIsbn());

        book.setIsbn("978-0-306 40615-6"); // Enunciat
        assertEquals("9780306406156", book.getIsbn());

        book.setIsbn("          978-0-306 40615-6"); // Espais
        assertEquals("9780306406156", book.getIsbn());
